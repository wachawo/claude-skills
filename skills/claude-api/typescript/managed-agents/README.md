...
> **Bindings not shown here:** This README covers the most common managed-agents flows for TypeScript. If you need a class, method, namespace, field, or behavior not shown here, WebFetch the TypeScript SDK repository **or the corresponding documentation page** from `shared/live-sources.md` rather than guessing. Do not extrapolate from cURL forms or another language's SDK.
